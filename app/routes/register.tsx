...
import { Input, PasswordInput, Button, Label } from "~/components/form";
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="grid gap-2">
              ...
              {fieldErrors.phone_number && (
                <p className="text-sm text-destructive">{fieldErrors.phone_number}</p>
              )}
            </div>
            ...
            <div className="grid gap-2">
              <Label htmlFor="reg-password-confirm">{t("common.confirmPassword")}</Label>
              <PasswordInput
          ...
          <CardFooter className="flex flex-col gap-2">
            ...
            <Button type="button" variant="link" asChild>
              <Link to="/login">{t("register.hasAccount")} {t("register.signInLink")}</Link>
            </Button>
          </CardFooter>
        </form>
      </Card>
