...
- Identified missing HasProjectPermission on procurement APIViews processing project-specific data via project_pk in URLs. Added permission_classes = [IsAuthenticated, HasProjectPermission] to _BaseApprovalActionView, AssignItemsView, PartialApproveView, and RequisitionItemHoldView. This mitigates horizontal privilege escalation risks.
