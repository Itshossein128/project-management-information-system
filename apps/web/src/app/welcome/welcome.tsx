...
export function Welcome() {
  return (
    <main className="flex min-h-svh items-center justify-center px-4 py-8 sm:py-16">
      <div className="flex min-h-0 w-full max-w-lg flex-1 flex-col items-center gap-10 sm:gap-16">
        <header className="flex w-full flex-col items-center gap-6 sm:gap-9">
        ...
        <div className="w-full max-w-sm space-y-6 px-2 sm:px-4">
          <nav className="rounded-3xl border border-border bg-card p-6 space-y-4">
