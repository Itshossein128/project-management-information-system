    ...
    <DialogPrimitive.Root open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            "fixed inset-y-0 end-0 z-50 flex h-full w-full max-w-md flex-col border-border bg-background shadow-xl border-s",
            "data-[state=closed]:animate-out data-[state=closed]:slide-out-to-end",
            "data-[state=open]:animate-in data-[state=open]:slide-in-from-end duration-300 outline-none"
          )}
        >
