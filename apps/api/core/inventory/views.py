        ...
        try:
            ...
            for index, row in df.iterrows():
                try:
                    ...
                    logger.exception("Error processing row %d", index + 2)
                    errors.append(f'Row {index + 2}: An error occurred while processing the row.')  # +2 because Excel rows start at 1 and header is row 1
            ...
            logger.exception("Error processing import items file")
            return Response(
