...
This module handles the core project management functionality within Velora, including projects, project members, roles, templates, and dynamic data tables.
