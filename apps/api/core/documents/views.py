...
from documents.services.correspondence_service import generate_corr_number, respond_correspondence
...
class CorrespondenceRespondView(APIView):
    ...
    def post(self, request, project_pk=None, pk=None):
        ...
        corr = respond_correspondence(corr, request.user, request.data)
