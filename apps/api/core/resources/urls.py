...
from resources.views import (
    ...
    MaterialRequestCancelView,
    MaterialRequestDeliverView,
    MaterialRequestPlaceOrderView,
...
urlpatterns = [
    ...
    path('material-requests/<uuid:pk>/approve/', MaterialRequestApproveView.as_view(), name='material-request-approve'),
    path('material-requests/<uuid:pk>/place-order/', MaterialRequestPlaceOrderView.as_view(), name='material-request-place-order'),
    path('material-requests/<uuid:pk>/deliver/', MaterialRequestDeliverView.as_view(), name='material-request-deliver'),
    path('material-requests/<uuid:pk>/cancel/', MaterialRequestCancelView.as_view(), name='material-request-cancel'),
