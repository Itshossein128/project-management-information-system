...
def create_material_request(project_id, validated_data):
    """
    Computes derived fields (request_number, unit, request_date) and returns
    a dictionary of kwargs to be used for saving the material request.
    """
