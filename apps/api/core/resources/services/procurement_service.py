...
def compute_material_request_defaults(project_id: str, validated_data: dict) -> dict:
    """
    Computes derived fields (request_number, unit, request_date) for a new material request.
    """
